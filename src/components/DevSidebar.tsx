			...
			>
				...
				<div className="space-y-6">
					...
					<div>
						<label
							htmlFor="temperature"
							className="mb-1.5 flex justify-between text-xs font-semibold uppercase tracking-wide text-muted"
						>
						...
						<div className="flex items-start gap-2 rounded-lg border border-hairline bg-page p-3 text-xs leading-relaxed">
							...
							{tracing ? (
								...
								<p className="text-ink-2">
									...
									— set <span className="font-mono">LANGSMITH_TRACING</span> and{" "}
									<span className="font-mono">LANGSMITH_API_KEY</span> in{" "}
